...
#ifndef FOUR_POINT_LOAD_UNLOAD_BEHAVIOR_FORWARD
#define FOUR_POINT_LOAD_UNLOAD_BEHAVIOR_FORWARD
...
// it goes and does a servillenge of the area (going forward). Once the other object comes to another stop, it comes back and hovers over that object.
// This behavior is used for the servillence cameras

class FourPointLoadUnloadBehaviorForward :
	public IBehavior
{
public:
...
public:
	FourPointLoadUnloadBehaviorForward(float maxDistance = 10.0f);
	virtual ~FourPointLoadUnloadBehaviorForward();
