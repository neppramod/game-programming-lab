...
FourPointLoadUnloadBehaviorBackward::FourPointLoadUnloadBehaviorBackward(float maxDistance)
{
...
FourPointLoadUnloadBehaviorBackward::~FourPointLoadUnloadBehaviorBackward()
{
}

void FourPointLoadUnloadBehaviorBackward::update(GameObject *object, float elapsedSeconds)
{
	...
	case STOP: {
		...
		obj->referenceFrame.moveBackward(stopDelta);
